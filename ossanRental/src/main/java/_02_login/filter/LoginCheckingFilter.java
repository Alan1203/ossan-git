...
public class LoginCheckingFilter implements Filter {
	...
	private boolean checkLogin(HttpServletRequest req) {
		...
		MemberOssanBean loginToken = (MemberOssanBean) session.getAttribute("LoginOK");
		MemberOssanBean loginTokenAdmin = (MemberOssanBean) session.getAttribute("AdminLoginOK");
		if (loginToken == null && loginTokenAdmin == null) {
			return false;
		} else {
			return true;
		}
